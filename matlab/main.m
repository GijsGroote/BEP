function [ reconstructedVideoSVR, faultyVideo, selectionMatrixVar, relativeErrorVar, originalVideo, R, faultyVector] = main( videoName, percentage, destructionType, lambda, mu )
%INPUT

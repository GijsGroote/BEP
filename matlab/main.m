function [ reconstructedVideoSVR, faultyVideo, selectionMatrixVar, relativeErrorVar, originalVideo, R, faultyVector, colours] = main( videoName, percentage, destructionType, lambda, mu )
%INPUT
...
try
    [selectionMatrixVar, R] = selectionMatrix(frameHeight, frameWidth,  numFrames, percentage, destructionType);
catch
...
try
    [faultyVideo, faultyVector] = VideoDestroyer(frameHeight, frameWidth, originalVideo, selectionMatrixVar, numFrames, colours);
catch
